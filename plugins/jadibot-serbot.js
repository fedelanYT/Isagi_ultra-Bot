...
/*if (Object.values(global.conns).length === 50) {
return m.reply(`${emoji2} No se han encontrado espacios para *Sub-Bots* disponibles.`)
}*/
...
msgRetry,
msgRetryCache,
browser: mcode ? ['Ubuntu', 'Chrome', '110.0.5585.95'] : ['black-clover-MD (Sub Bot)', 'Chrome','2.0.0'],
version: version,
